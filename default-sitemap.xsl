...
>
	...
	<div id="content-head">
		...
		<p>Generated by <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=proplugin&#038;utm_medium=xml-sitemap" target="_blank">All in One SEO Pro</a>, this is an XML Sitemap, meant to be consumed by search engines like Google or Bing.</p>
		<p>
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on 17 December, 2023 at 3:24 AM			</p>
		</xsl:if>
	</div>
</xsl:template>
